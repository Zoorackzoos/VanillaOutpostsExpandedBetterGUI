    ...
    public static class OutpostPawnGizmoPatch
    {
    		...
    		Caravan caravan)
		{
    		...
    		foreach (var gizmo in __result)
    		{
        		if (gizmo is Command_Action cmd)
        		{
            		...
            		{
                		Log.Message("[VOEBetterPawnUI] Replacing Add Pawn gizmo.");
            		...
            		{
                		Log.Message("[VOEBetterPawnUI] Replacing Take Pawn gizmo.");
                		yield return new Command_Action
                		{
                    		action         = () => Find.WindowStack.Add(
            ...
            Outpost __instance)
        {
            ...
            foreach (var gizmo in __result)
            {
                ...
                {
                    Log.Message("[VOEBetterPawnUI] Replacing Remove Pawn gizmo.");
                    yield return new Command_Action
                    {
                        action         = () => Find.WindowStack.Add(
